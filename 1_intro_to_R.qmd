...
inperson <- ifelse(!online, "visible", "hidden")
online <- ifelse(online, "visible", "hidden")
ta <- ifelse(ta, "visible", "hidden")
...
## Introductions  {.nostretch visibility=`r ta`}
...
-   Associate Professor in Geography and Environment,   
    Brandon University
-   Developer of R package [mbquartR](https://docs.ropensci.org/mbquartR/)

![](figures/alex.jpg){.absolute right=10 top=50 width=40% fig-alt="Alex smiling and holding a handful of forage/grass out to the viewer"}

![](figures/mbquartR.png){.absolute left=150 bottom=50 width=15% fig-alt="mbquartR package logo"}
...
-   Creatures (furry, feathery, scaley, humanoid, green or otherwise)?
...
## About this Workshop {visibility=`r online`}
<!-- Online -->
...
### Questions
-   Ask questions by un-muting, or ask in the chat
...
### Getting help
-   Share your screen
-   Share your code - <https://codeshare.io/5zY31W>
...
![](figures/horst_need_a_moment.png){fig-align="center" width=30% fig-alt="A frustrated little monster sits on the ground with his hat next to him, saying \"I just need a minute.\" Looking on empathetically is the R logo, with the word \"Error\" in many different styles behind it."}
    
## About this Workshop {visibility=`r inperson`}
<!-- In person -->
...
[Let's talk about the *parts* of the code first<br>Later we'll talk about why this works]{.note .absolute top="5%" left=45%}
...
**Vectors** 
```{r, results = "hide"}
fruit <- c("apples", "bananas", "pears", "oranges", "melons")
fruit
```
...
production <- data.frame(
  ...
  fruit = c("apples", "bananas", "apples", "bananas"),
  count = c(20, 60, 30, 50))
production
```
...
fruit
fruit[2]
fruit[2:5]     # What does : do?
fruit[c(1, 3)] # What does c() do?
