...
format: 
  revealjs:
    ...
    title-slide-attributes: 
      data-background-image: figures/R.png
...
## This is me and my creatures {{< fa cat >}}{.pic background-color="black" background-image="figures/creatures.jpg"}

## This is my garden {{< fa tree >}} {.pic background-color="black" background-image="figures/garden.jpg"} 
...
-   Fifth year giving BU R Workshop!
-   [rOpenSci](https://ropensci.org) Community Assistant

![](figures/steffi_vivi.jpg){.absolute right=10 top=50 width=40%}
...
![](figures/impostR_en.png){.absolute top=10%}
...
![RStudio](https://d33wubrfki0l68.cloudfront.net/3099a8a5ab437c8cca2446dfb08383ecfca761ec/0377b/wp-content/uploads/2014/06/rstudio-ball.png){width="20%"}
...
[Let's take a look at RStudio!]{.note .absolute top=45% left=75%}
...
![ ](figures/mean_docs.png){.absolute bottom=5% right=0% height=83%}
...
[rows x columns]{.note .absolute bottom=0 left=70%}
...
![](https://cdn.myportfolio.com/45214904-6a61-4e23-98d6-b140f8654a40/d4f90788-7a14-4d44-94ab-da13dd41f009.png?h=585957612c146dc43c4aa63e9431ad1b){fig-align=center}
...
![](figures/happy_r.png){fig-align=center}
