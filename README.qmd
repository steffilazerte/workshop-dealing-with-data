...
5. Getting help with R ([html](https://steffilazerte.ca/workshop-dealing-with-data/5_getting_help.html)|[pdf](https://steffilazerte.ca/workshop-dealing-with-data/pdf/5_getting_help_sm.pdf)|[html-answers](https://steffilazerte.ca/workshop-dealing-with-data/5_getting_help_answers.html)|[pdf-answers](https://steffilazerte.ca/workshop-dealing-with-data/pdf/5_getting_help_answers_sm.pdf))
...
> - Problems with `tidyverse`? Try installing the packages we need by hand: `dplyr`, `tidyr`, `readr`, `ggplot2`, `lubridate`
