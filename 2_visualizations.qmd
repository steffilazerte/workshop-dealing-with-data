...
[**Too Easy?**<br>Plot points on top<br><small>Why not consider jittering them?</small>]{.note .absolute left=80% top=5% width=250}
...
[**Note**: When forcing, aesthetic is not inside `aes()`]{.note .fragment .absolute left=75% top=5% width=350}
...
#| fig-width: 5
#| out-width: 100%
g + theme(legend.position = c(0.85, 0.2))
```
:::
:::
...
#| fig-asp: 1
#| fig-width: 6
plot(1:25, 1:25, pch = 1:25, bg = "red")
```
...
- [R Graphics Cookbook](https://r-graphics.org/) [by Winston Chang]{.small}
